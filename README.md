...
![Project Banner](https://placehold.co/1200x400/3367d6/ffffff?text=EasyMED+Project)
<p align="center">
  <a href="#-项目简介">项目简介</a> •
  <a href="#-核心功能">核心功能</a> •
  <a href="#-研究目标">研究目标</a> •
...
### 4. 盲法设计 (Blinding)
* **评估者盲法 (Assessor Blinding):** 负责在第2周和第4周组织考试并评分的考官**不知道**学生的分组情况（即他们不知道哪些学生使用了 **EasyMED**，哪些学生与真人医生练习）。
